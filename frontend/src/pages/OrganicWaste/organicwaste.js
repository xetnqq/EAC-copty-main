...
export class OrganicWaste extends Component {
    ...
    componentDidMount() {
      ...
      handleImageClick = (event) => {
        ...
        const isLowBattery = currentSrc.includes('OrganicEmpty.png');
        event.target.src = isLowBattery ? './img/Organic.png' : './img/OrganicEmpty.png';
      }
    ...
    return (
      <>
        ...
        <div className='penis-1'>
         <img src='./img/OrganicEmpty.png' alt='' className='balls-1'/>
         <img src='./img/OrganicEmpty.png' alt='' className='balls-1'/>
         <img src='./img/OrganicEmpty.png' alt='' className='balls-1'/>
         <img src='./img/OrganicEmpty.png' alt='' className='balls-1'/>
         <img src='./img/OrganicEmpty.png' alt='' className='balls-1'/>
